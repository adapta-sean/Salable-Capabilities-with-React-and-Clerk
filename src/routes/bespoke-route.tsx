...
type BespokeDashboardProps = {
    capability?: string,
}

export default function BespokeRoute({capability}: BespokeDashboardProps) {
    ...
    if (capability && !hasCapability(capability)) return (
        <div className='container mx-auto my-8'>
            <div role="alert" className="alert bg-base-300 mb-6">
                ...
                <span>Not Authorised, only available to users with the `bespoke` capability</span>
            </div>
    ...
    return (
        <>
            <h1 className='text-2xl mb-4 font-bold'>Bespoke Dashboard</h1>
            <Outlet/>
        </>
    )
}